			  ...
			  <div class="panel-body">
			  	{{-- <form action="{{ route('absen.store') }}" method="post" enctype="multipart/form-data">
					  ...
					  <div class="form-group {{ $errors->has('tanggal') ? ' has-error' : '' }}">
			  			...
			  			<input type="date" name="tanggal" class="form-control" value="{{ carbon\carbon::today()->toDateString() }}" readonly>
                      ...
                      <div class="form-group {{ $errors->has('jam_masuk') ? ' has-error' : '' }}">
			  			...
			  			<input type="time" name="jam_masuk" value="{{ carbon\carbon::now()->timezone('Asia/Jakarta')->format('H:i:s') }}" class="form-control"  readonly>
